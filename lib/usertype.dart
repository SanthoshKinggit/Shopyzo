...
class _UserTypeSelectionState extends State<UserTypeSelection>
  ...
  final List<UserTypeItem> _userTypes = [
    ...
    UserTypeItem(
      ...
      backgroundColor: const Color.fromARGB(255, 144, 48, 185),
      iconColor: Colors.white,
    ...
    UserTypeItem(
      ...
      backgroundColor:const Color.fromARGB(255, 124, 32, 164),
      iconColor: Colors.white,
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontWeight: FontWeight.w500, // Light weight for the title
                      color: Colors.white,
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 14,
                      fontWeight:
                          FontWeight.w400, // Lighter weight for description
                      color: Colors.white.withOpacity(0.8),
                    ),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        // Slightly more than screen height
        decoration: BoxDecoration(
          gradient: LinearGradient(
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(child: Image.asset('assets/logo/3309577.jpg',fit: BoxFit.fill,)),
...
class _AttractiveRegistrationFormState extends State<AttractiveRegistrationForm>
  ...
  // Helper to check if all form fields are filled and valid
  bool _isFormValid() {
    for (var tab in _tabs) {
      for (var field in tab['fields']) {
        if (field['controller'] != null && field['controller'].text.isEmpty) {
          return false; // Field is empty
        }
        if (field['type'] == 'dropdown' && field['value'] == null) {
          return false; // Dropdown value is not selected
        }
      }
    }
